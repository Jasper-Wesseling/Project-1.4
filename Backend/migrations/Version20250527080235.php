 ...
 */
final class Version20250527080235 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE messages CHANGE content content JSON DEFAULT NULL COMMENT '(DC2Type:json)', CHANGE reciever_id_id receiver_id_id INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE messages CHANGE content content LONGTEXT NOT NULL, CHANGE receiver_id_id reciever_id_id INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
