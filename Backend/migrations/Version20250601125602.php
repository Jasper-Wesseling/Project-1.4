 ...
 */
final class Version20250601125602 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE messages (id INT AUTO_INCREMENT NOT NULL, sender_id_id INT NOT NULL, receiver_id_id INT NOT NULL, product_id_id INT DEFAULT NULL, post_id_id INT DEFAULT NULL, timestamp DATETIME NOT NULL, content JSON DEFAULT NULL COMMENT '(DC2Type:json)', INDEX IDX_DB021E966061F7CF (sender_id_id), INDEX IDX_DB021E96BE20CAB0 (receiver_id_id), INDEX IDX_DB021E96DE18E50B (product_id_id), INDEX IDX_DB021E96E85F12B8 (post_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
